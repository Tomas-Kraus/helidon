...
import io.helidon.data.builder.query.DynamicFinderSelection.Projection;
...
public class JpaQueryTransformation implements QueryTransformation {
    ...
    private boolean isNextCriteriaExpression;
    private String criteriaExpressionProperty;
    private boolean criteriaExpressionNot;
    private DynamicFinderCriteria.Expression.Condition.Operator criteriaExpressionOperator;
    ...
    public JpaQueryTransformation() {
        ...
        this.isNextCriteriaExpression = false;
    ...
    @Override
    public void start(final String entityName) {
    ...
    @Override
    public void selectionProperty(final String selectionPproperty) {
    ...
    @Override
    public void finishSelection(final DynamicFinderSelection selection) {
        stmtBuilder.append(' ');
    ...
    @Override
    public void startCriteria(final DynamicFinderCriteria criteria) {
        stmtBuilder.append(" WHERE");
        isNextCriteriaExpression = !criteria.next().isEmpty();
    }

    @Override
    public void startFirstCriteriaExpression(final DynamicFinderCriteria.Expression expression) {
        // Enclose multiple values in brackets when multiple expressions exist
        if (isNextCriteriaExpression) {
            stmtBuilder.append(" (");
        } else {
            stmtBuilder.append(' ');
        }
    ...
    @Override
    public void nextCriteriaExpressionOperator(final DynamicFinderCriteria.NextExpression.Operator operator) {
        switch(operator) {
    ...
    @Override
    public void firstCriteriaExpressionProperty(final String property) {
        criteriaExpressionProperty = String.format("%s.%s", entityAlias, property);
    }

    @Override
    public void nextCriteriaExpressionProperty(final String property) {
        firstCriteriaExpressionProperty(property);
    }

    @Override
    public void firstCriteriaExpressionNot(final boolean not) {
        criteriaExpressionNot = not;
    }

    @Override
    public void nextCriteriaExpressionNot(final boolean not) {
        firstCriteriaExpressionNot(not);
    }

    @Override
    public void startFirstCriteriaExpressionCondition(final DynamicFinderCriteria.Expression.Condition condition) {
        // Internal condition values indexing, starts from 0.
        criteriaExpressionValueIndex = 0;
    }

    @Override
    public void startNextCriteriaExpressionCondition(final DynamicFinderCriteria.Expression.Condition condition) {
        startFirstCriteriaExpressionCondition(condition);
    }


    @Override
    public void firstCriteriaExpressionConditionOperator(final DynamicFinderCriteria.Expression.Condition.Operator operator) {
    ...
    @Override
    public void nextCriteriaExpressionConditionOperator(final DynamicFinderCriteria.Expression.Condition.Operator operator) {
        firstCriteriaExpressionConditionOperator(operator);
    }

    @Override
    public void firstCriteriaExpressionConditionValue(final String value) {
    ...
    @Override
    public void nextCriteriaExpressionConditionValue(final String value) {
        firstCriteriaExpressionConditionValue(value);
    }

    @Override
    public void finishFirstCriteriaExpression(final DynamicFinderCriteria.Expression expression) {
        // Enclose multiple values in brackets when multiple expressions exist
        if (isNextCriteriaExpression) {
            stmtBuilder.append(")");
        }
    ...
    @Override
    public  void finishNextCriteriaExpression(final DynamicFinderCriteria.Expression expression) {
        stmtBuilder.append(")");
    }

    @Override
    public void startOrder(final DynamicFinderOrder order) {
        stmtBuilder.append(" ORDER BY");
        firstOrderRule = true;
    }

    @Override
    public void startOrderRule(final DynamicFinderOrder.Order rule) {
        if (firstOrderRule) {
    ...
    @Override
    public void orderRuleProperty(final String property) {
        stmtBuilder.append(" ");
        stmtBuilder.append(property);
    }

    @Override
    public void orderRuleMethod(final DynamicFinderOrder.Order.Method method) {
