...
public class DynamicFinderBuilderTest {
    ...
    public void evaluateResultOnly(
    ...
    // Helper method to evaluate use-cae with result and projection selected.
    public void evaluateResultAndProjectionOnly(
            final DynamicFinder query,
            final DynamicFinderSelection.Method selectionMethod,
    ...
    public void evaluateResultAndProjectionTopOnly(
            final DynamicFinder query,
            final DynamicFinderSelection.Method selectionMethod,
    ...
    public void evaluateResultByCondition(
            final DynamicFinder query,
            String parameter,
            final boolean not,
