...
import io.helidon.data.processor.RepositoryBuilderException;

/**
 * A {@link RuntimeException} to report data repository query method parser error.
 */
public class MethodParserException extends RepositoryBuilderException {
