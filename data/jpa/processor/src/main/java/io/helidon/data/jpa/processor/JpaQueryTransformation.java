...
import io.helidon.data.processor.DynamicFinderSelection.Projection;
...
public class JpaQueryTransformation implements QueryTransformation {
    ...
    @Override
    public void startFirstCriteriaExpression(DynamicFinderCriteria.Expression expression) {
    ...
    @Override
    public void nextCriteriaExpressionOperator(DynamicFinderCriteria.NextExpression.Operator operator) {
        switch(operator) {
    ...
    @Override
    public void firstCriteriaExpressionProperty(String property) {
        criteriaExpressionProperty = String.format("%s.%s", entityAlias, property);
    }

    @Override
    public void nextCriteriaExpressionProperty(String property) {
        firstCriteriaExpressionProperty(property);
    }

    @Override
    public void firstCriteriaExpressionNot(boolean not) {
        criteriaExpressionNot = not;
    }

    @Override
    public void nextCriteriaExpressionNot(boolean not) {
        firstCriteriaExpressionNot(not);
    }

    @Override
    public void startFirstCriteriaExpressionCondition(DynamicFinderCriteria.Expression.Condition condition) {
        // Internal condition values indexing, starts from 0.
        criteriaExpressionValueIndex = 0;
    }

    @Override
    public void startNextCriteriaExpressionCondition(DynamicFinderCriteria.Expression.Condition condition) {
        startFirstCriteriaExpressionCondition(condition);
    }


    @Override
    public void firstCriteriaExpressionConditionOperator(DynamicFinderCriteria.Expression.Condition.Operator operator) {
    ...
    @Override
    public void nextCriteriaExpressionConditionOperator(DynamicFinderCriteria.Expression.Condition.Operator operator) {
        firstCriteriaExpressionConditionOperator(operator);
    }

    @Override
    public void firstCriteriaExpressionConditionValue(String value) {
    ...
    @Override
    public void nextCriteriaExpressionConditionValue(String value) {
        firstCriteriaExpressionConditionValue(value);
    }

    @Override
    public void finishFirstCriteriaExpression(DynamicFinderCriteria.Expression expression) {
        // Enclose multiple values in brackets when multiple expressions exist
        if (isNextCriteriaExpression) {
            stmtBuilder.append(")");
        }
    ...
    @Override
    public  void finishNextCriteriaExpression(DynamicFinderCriteria.Expression expression) {
        stmtBuilder.append(")");
    }
