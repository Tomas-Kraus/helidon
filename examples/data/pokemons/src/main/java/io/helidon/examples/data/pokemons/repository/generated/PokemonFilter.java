...
public interface PokemonFilter extends PokemonCriteria, PokemonOrder {

    interface Builder extends PokemonCriteria.Builder<Builder, PokemonFilter>, PokemonOrder.Builder<Builder, PokemonFilter> {
    }
...
class PokemonFilterImpl implements PokemonFilter {
    ...
    private PokemonFilterImpl(Optional<DynamicFinderCriteria> criteria, Optional<DynamicFinderOrder> order) {
    ...
    static class BuilderImpl implements Builder {
        ...
        public Builder orderByType(TypeOrder order) {
        ...
        public PokemonFilter build() {
            ...
            return new PokemonFilterImpl(criteria, order);
        }
