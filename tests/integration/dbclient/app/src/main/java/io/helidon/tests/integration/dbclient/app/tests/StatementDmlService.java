 ...
 */
public class StatementDmlService extends AbstractService {

    private static final System.Logger LOGGER = System.getLogger(StatementDmlService.class.getName());

    public StatementDmlService(DbClient dbClient, Map<String, String> statements) {
