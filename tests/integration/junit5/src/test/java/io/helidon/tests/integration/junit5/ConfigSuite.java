...
@TestConfig(key = ConfigSuite.CONFIG_KEY)
public class ConfigSuite implements SuiteProvider {

    final static String CONFIG_KEY = "ConfigSuite.config.key";
    ...
    public void beforeSuite() {
        System.out.println(String.format("Running beforeSuite of ConfigSuite test class, order %d", counter));
    ...
    public void afterSuite() {
        System.out.println(String.format("Running afterSuite of ConfigSuite test class, order %d", counter));
        suiteContext.storage().put(AFTER_KEY, counter);
    }

    @SetUpConfig
    public void setupConfig(Config.Builder builder) {
        System.out.println(String.format("Running setupConfig of ConfigSuite test class, order %d", counter));
