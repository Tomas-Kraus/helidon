...
public class SimpleSuite implements SuiteProvider {
    ...
    public void beforeSuite() {
        System.out.println(String.format("Running beforeSuite of SimpleSuite test class, order %d", counter));
    ...
    public void afterSuite() {
        System.out.println(String.format("Running afterSuite of SimpleSuite test class, order %d", counter));
        suiteContext.storage().put(AFTER_KEY, counter);
    }

    @SetUpConfig
    public void setupConfig() {
        System.out.println(String.format("Running setupConfig of SimpleSuite test class, order %d", counter));
        suiteContext.storage().put(SETUP_CONFIG_KEY, counter++);
    }

    @SetUpContainer
    public void setupContainer() {
        System.out.println(String.format("Running setupContainer of SimpleSuite test class, order %d", counter));
